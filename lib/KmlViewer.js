...
export default class KmlViewer extends Component {
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    console.log('KmlViewer.getDerivedStateFromProps', stateChanges); // Notify container

    if (stateChanges.kml !== undefined && props.onKmlChange) props.onKmlChange(stateChanges.kml);
    return stateChanges;
  }
