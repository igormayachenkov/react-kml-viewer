...
export function parseFromDOMDocument(domDocument) {
  ...
  if (!kml) throw String('KML format error: Element "kml" is not found'); //let elementDocument = getChildByTagName(kml,"Document");    //domDocument.getElementsByTagName("Document")[0]
